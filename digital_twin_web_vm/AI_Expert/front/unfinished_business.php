...
<body>
    <div class="title">
        <p>[1] 上傳照片 ➡️ [2] 動作遷移影片結果 ➡️ <span class="text-color">[3]專員訪談-基本資料(5/6)</span> ➡️ [4] 測試數位分身 ➡️ [5] 公開數位分身</p>
    </div>
    ...
    <div class="card-bg">
        <div class="login-container">
            <form action="../end/save_user_info.php" method="post" class="life-unfinished_business-form">
                <h2 class="text-center">未完成的事</h2> 
    ...
    <script src="./js/unfinished_business.js"></script>
