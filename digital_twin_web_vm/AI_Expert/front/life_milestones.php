...
<body>
    <div class="title">
        <p>[1] 上傳照片 ➡️ [2] 動作遷移影片結果 ➡️ <span class="text-color">[3]專員訪談-基本資料(2/6)</span> ➡️ [4] 測試數位分身 ➡️ [5] 公開數位分身</p>
    </div>
    ...
    <div class="card-bg">
        <div class="login-container">
            <form action="../end/save_user_info.php" method="post" class="life-milestones-form">
                <h2 class="text-center">人生大事記記錄</h2> 
    ...
    <script src="./js/life_milestones.js"></script>
