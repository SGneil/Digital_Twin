...
<head>
  ...
  <link rel="stylesheet" href="./css/management_interface.css">
</head>
    ...
    <div class="card-bg">
        ...
        <div class="user-profile-container">
            <div class="select-card">
                <h4>歡迎進入管理員介面</h4>
                <p></p>
                <a href="../../Admin/front/management_user.php" class="btn">
                    管理所有使用者資訊
        ...
        <div class="user-profile-container">
            <div class="select-card">
                <h4>歡迎進入管理員介面</h4>
                <p></p>
                <a href="../../Admin/front/management_server.php" class="btn">
                    管理所有API
                    <span></span><span></span><span></span><span></span>
                </a>
            </div>
