<?php
    ...
    $user_chat_history = load_user_chat($_GET['account_id']);
?>
        ...
        <div class="table-size">
            ...
            <?php if ($user_chat_history): ?>
                <table>
                    ...
                    <?php foreach($user_chat_history as $user_chat): ?>
                    <tr class="ani-bg">
                        <td>
                            <?php echo htmlspecialchars($user_chat["role"]);?>
                        </td>
                        <td>
                            <?php echo htmlspecialchars($user_chat["topic"]);?>
                        </td>
                        <td>
                            <?php echo htmlspecialchars($user_chat["content"]);?>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </table>
